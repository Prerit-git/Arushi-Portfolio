    ...
    <section className="w-full max-w-6xl mx-auto pb-20 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-[100px]">
      <div className="pr-0 md:pr-20">
        ...
        <ul className=" text-[#4F4D4D] space-y-4">
          <li>
            <span className="font-bold">Decision 1:</span> Shift from static
            pages to story-driven exploration
          </li>
          <li>
            <span className="font-bold">Decision 2:</span> Structure complex CSR
            data into a navigable information system
          </li>
          <li>
            <span className="font-bold">Decision 3:</span> Simplify deeply
            layered information without losing depth
          </li>
        </ul>
      </div>
      ...
      <div className="gap-10">
        ...
        <div className="col-span-10 md:col-span-8 mt-18 flex flex-col gap-[16px]">
          <p className="text-[16px] font-bold">
            Decision 1: Structure complex CSR data into a navigable information
            system
          </p>
          <p className=" text-[#9CA3C7] font-bold">PROBLEM</p>
          <p className=" text-[#4F4D4D]">
            CSR initiatives spanned multiple themes, regions, and programs with
            no unified structure.
          </p>
          <p className=" text-[#9CA3C7] font-bold">WHAT I DID</p>
          <p className="text-[#4F4D4D]">
            Defined a clear IA framework that allowed users to explore CSR work
            through:
          </p>
          <ul className="list-disc list-inside">
            <li className="text-[#4F4D4D] ">
              Themes (education, environment, etc.)
            </li>
          ...
          <p className="text-[#4F4D4D]">
            Created a system where users could both browse broadly and dive
            deep, depending on their intent.
          </p>
          {/* <video
        ...
        <div className="col-span-10 md:col-span-8 mt-18 flex flex-col gap-[16px]">
          ...
          <p className=" text-[#9CA3C7] font-bold">WHAT I DID</p>
          <p className="text-[#4F4D4D]">
            Reframed the website as a storytelling platform, where each
            initiative:
          </p>
          <ul className="list-disc list-inside">
            <li className="text-[#4F4D4D] ">
              Communicates purpose, scale, and outcomes
            </li>
            <li className="text-[#4F4D4D] ">
              Uses structured content blocks for clarity
            </li>
            <li className="text-[#4F4D4D] ">
              Builds a cohesive narrative across the site
            </li>
          </ul>
          <p className=" text-[#9CA3C7] font-bold">OUTCOME</p>
          <p className="text-[#4F4D4D]">
        ...
        <div className="col-span-10 md:col-span-8 mt-18 flex flex-col gap-[16px]">
          ...
          <p className=" text-[#9CA3C7] font-bold">PROBLEM</p>
          <p className=" text-[#4F4D4D]">
            Information was highly detailed and interconnected, risking
            overwhelm.
          </p>
          <p className="text-[14px] text-[#9CA3C7] font-bold">WHAT I DID</p>
          <p className="text-[#4F4D4D]">
            Introduced layered information hierarchy:
          </p>
          <ul className="list-disc list-inside">
            <li className="text-[#4F4D4D] ">
          ...
          <p className=" text-[#9CA3C7] font-bold">OUTCOME</p>
          <p className="text-[#4F4D4D]">
            Balanced depth with readability, enabling both quick scans and
