...
const BlogsSection = ()=>{
    ...
    return(
        <>
        <section className="px-5 md:px-[90px] py-10 pb-20 md:py-20 flex flex-col gap-20 bg-[#FFBBE6] h-auto" id="blog-section">
    ...
    <motion.div
            className="relative mt-[0px] md:mt-[32px] flex justify-center"
            whileHover={{ y: -2 }}
            whileTap={{ y: 2 }}
          >
            <motion.button onClick={()=> router.push("/blogs")}
              className="absolute -bottom-8 z-30 bg-[#FFE2E2] text-black font-semibold text-[16px] w-[172px] h-[46px] rounded-[4px] flex items-center justify-center cursor-pointer gap-2"
            >
