  ...
  return (
    <>
      ...
      <section
        id=""
        ref={sectionRef}
        className="flex flex-col lg:flex-row justify-between items-center h-screen w-full mx-auto px-0 md:px-[90px] pt-0 md:pt-22"
      >
        {/* Left section */}
        <div className="flex-1 flex flex-col">
          <h1 className="md:self-start text-[40px] font-normal text-[#FFE2E2]">
            Hey! I'm Arushi Mathur,
          </h1>
          <h2 className="text-[32px] text-[#FFE2E2]">
            a ‘Product Designer’ who enjoys bringing clarity to complex systems.
          </h2>

          <p className="text-[#FFFFFF] my-[54px] w-[80%] text-[20px]">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="hidden relative bottom-0 z-40 md:flex flex-col w-fit"
          >
